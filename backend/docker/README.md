...
```sh
docker run -e MONGO_URI="mongodb+srv://shizzuzeal:shizzuzeal@notesapp-cluster.d7n2tci.mongodb.net/?appName=notesapp-cluster" -e JWT_SECRET="abc123" -p 5000:5000 notes-backend:latest
```
